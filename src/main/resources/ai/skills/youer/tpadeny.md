---
id: youer.tpadeny
title: Tpadeny Command
description: Deny the requester's pending teleport request.
commands: [tpadeny]
...
# Purpose
Deny the requester's pending teleport request. This Skill describes the command shipped and registered by Youer.
