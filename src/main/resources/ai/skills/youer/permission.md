...
description: Check whether a player has a Bukkit permission node.
commands: [permission]
...
# Purpose
Check whether a player has a Bukkit permission node. This Skill describes the command shipped and registered by Youer.
...
# Examples
`/permission check PlayerName youer.command.youer`
