...
id: youer.hat
title: Hat Command
description: Move the held item into the player's helmet slot.
commands: [hat]
...
# Purpose
Move the held item into the player's helmet slot. This Skill describes the command shipped and registered by Youer.
