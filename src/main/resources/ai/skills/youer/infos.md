...
id: youer.infos
title: Infos Command
description: Inspect the held item, targeted block or entity, command, or item components.
commands: [infos]
...
# Purpose
Inspect the held item, targeted block or entity, command, or item components. This Skill describes the command shipped and registered by Youer.
