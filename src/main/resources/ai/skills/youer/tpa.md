...
id: youer.tpa
title: Tpa Command
description: Send a teleport request to another online player.
commands: [tpa]
...
# Purpose
Send a teleport request to another online player. This Skill describes the command shipped and registered by Youer.
