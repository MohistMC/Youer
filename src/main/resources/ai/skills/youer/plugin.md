...
description: Load, reload, or unload a Bukkit plugin.
commands: [plugin]
...
# Purpose
Load, reload, or unload a Bukkit plugin. This Skill describes the command shipped and registered by Youer.
