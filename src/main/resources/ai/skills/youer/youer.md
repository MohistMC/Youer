...
id: youer.youer
title: Youer Command
description: Run Youer administration, diagnostics, reload, version, healing, or backup operations.
commands: [youer]
...
# Purpose
Run Youer administration, diagnostics, reload, version, healing, or backup operations. This Skill describes the command shipped and registered by Youer.
