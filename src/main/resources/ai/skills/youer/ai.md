...
id: youer.ai
title: Ai Command
description: Use Youer's AI session controls to inspect tools, history, and pending confirmations.
commands: [ai]
...
# Purpose
Use Youer's AI session controls to inspect tools, history, and pending confirmations. This Skill describes the command shipped and registered by Youer.
