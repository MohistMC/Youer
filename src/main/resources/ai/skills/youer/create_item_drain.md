---
id: youer.create_item_drain
title: Create Item Drain Command
description: Configure Create mod item-drain potion restrictions when Create is installed.
commands: [create_item_drain]
...
# Purpose
Configure Create mod item-drain potion restrictions when Create is installed. This Skill describes the command shipped and registered by Youer.
...
# Examples
`/create_item_drain potionban show`
