...
id: youer.back
title: Back Command
description: Return to the player's recorded previous location.
commands: [back]
...
# Purpose
Return to the player's recorded previous location. This Skill describes the command shipped and registered by Youer.
