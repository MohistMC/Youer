---
id: youer.tpaccept
title: Tpaccept Command
description: Accept the requester's pending teleport request.
commands: [tpaccept]
...
# Purpose
Accept the requester's pending teleport request. This Skill describes the command shipped and registered by Youer.
