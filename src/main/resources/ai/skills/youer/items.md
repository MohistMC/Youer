...
id: youer.items
title: Items Command
description: Create, store, retrieve, give, remove, or edit Youer managed items.
commands: [items]
...
# Purpose
Create, store, retrieve, give, remove, or edit Youer managed items. This Skill describes the command shipped and registered by Youer.
