...
description: Toggle the requesting player's vanished state.
commands: [vanish]
...
# Purpose
Toggle the requesting player's vanished state. This Skill describes the command shipped and registered by Youer.
