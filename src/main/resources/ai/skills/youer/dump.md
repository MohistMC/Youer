...
id: youer.dump
title: Dump Command
description: Export server registry or command diagnostics to dump files.
commands: [dump]
...
# Purpose
Export server registry or command diagnostics to dump files. This Skill describes the command shipped and registered by Youer.
