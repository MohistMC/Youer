---
id: youer.logfilter
title: Logfilter Command
description: Inspect, reload, enable, or disable Youer's log filters.
commands: [logfilter]
...
# Purpose
Inspect, reload, enable, or disable Youer's log filters. This Skill describes the command shipped and registered by Youer.
