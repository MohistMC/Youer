---
id: youer.hideall
title: Hideall Command
description: Toggle hiding all eligible players from the requester.
commands: [hideall]
...
# Purpose
Toggle hiding all eligible players from the requester. This Skill describes the command shipped and registered by Youer.
