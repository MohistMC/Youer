...
id: youer.hide
title: Hide Command
description: Toggle the requesting player's visibility state.
commands: [hide]
...
# Purpose
Toggle the requesting player's visibility state. This Skill describes the command shipped and registered by Youer.
