...
id: youer.shows
title: Shows Command
description: Inspect nearby sounds, entities, or block entities.
commands: [shows]
...
# Purpose
Inspect nearby sounds, entities, or block entities. This Skill describes the command shipped and registered by Youer.
