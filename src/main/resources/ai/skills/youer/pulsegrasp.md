---
id: youer.pulsegrasp
title: Pulsegrasp Command
description: Start, stop, or inspect Youer's tick profiling sampler.
commands: [pulsegrasp]
...
# Purpose
Start, stop, or inspect Youer's tick profiling sampler. This Skill describes the command shipped and registered by Youer.
