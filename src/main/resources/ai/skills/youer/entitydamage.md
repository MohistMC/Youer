---
id: youer.entitydamage
title: Entitydamage Command
description: List or configure per-entity damage weakening percentages.
commands: [entitydamage]
...
# Purpose
List or configure per-entity damage weakening percentages. This Skill describes the command shipped and registered by Youer.
