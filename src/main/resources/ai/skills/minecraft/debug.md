...
id: minecraft.debug
title: Debug Command
description: Start, stop, or run server debug profiling.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/debug
---

# Purpose
Start, stop, or run server debug profiling. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
