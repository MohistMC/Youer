...
description: Remove a player profile from the ban list.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/pardon
---

# Purpose
Remove a player profile from the ban list. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
