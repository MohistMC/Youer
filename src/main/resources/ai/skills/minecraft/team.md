...
id: minecraft.team
title: Team Command
description: Create and configure scoreboard teams and membership.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/team
---

# Purpose
Create and configure scoreboard teams and membership. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
