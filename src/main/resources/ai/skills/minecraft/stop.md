...
id: minecraft.stop
title: Stop Command
description: Save and shut down the dedicated server.
edition: java
...
# Purpose
Save and shut down the dedicated server. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
