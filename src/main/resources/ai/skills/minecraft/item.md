...
id: minecraft.item
title: Item Command
description: Inspect or replace items in inventories and containers.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/item
---

# Purpose
Inspect or replace items in inventories and containers. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
