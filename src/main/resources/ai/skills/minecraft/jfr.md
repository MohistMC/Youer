...
id: minecraft.jfr
title: Jfr Command
description: Control Java Flight Recorder profiling for the server.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/jfr
---

# Purpose
Control Java Flight Recorder profiling for the server. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
