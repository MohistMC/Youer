...
id: minecraft.perf
title: Perf Command
description: Start or stop the dedicated server performance recorder.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/perf
---

# Purpose
Start or stop the dedicated server performance recorder. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
