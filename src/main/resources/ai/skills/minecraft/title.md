...
id: minecraft.title
title: Title Command
description: Display or configure title messages for players.
edition: java
...
execution: console
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/title
---

# Purpose
Display or configure title messages for players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
