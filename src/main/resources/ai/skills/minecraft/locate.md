...
description: Find the nearest structure, biome, or point of interest.
edition: java
...
execution: player
risk: READ_ONLY
source: https://minecraft.wiki/w/Commands/locate
---

# Purpose
Find the nearest structure, biome, or point of interest. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
