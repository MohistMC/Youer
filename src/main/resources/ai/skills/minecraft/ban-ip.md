...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/ban-ip
---

# Purpose
Ban an IP address from the server. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
