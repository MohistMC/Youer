...
description: Apply, clear, or inspect status effects.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/effect
---

# Purpose
Apply, clear, or inspect status effects. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
