...
description: Allow a player to modify an enabled trigger objective.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/trigger
---

# Purpose
Allow a player to modify an enabled trigger objective. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
