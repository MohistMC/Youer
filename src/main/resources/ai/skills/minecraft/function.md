...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/function
---

# Purpose
Run a data-pack function. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
