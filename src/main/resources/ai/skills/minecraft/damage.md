...
description: Apply a specified damage type to an entity.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/damage
---

# Purpose
Apply a specified damage type to an entity. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
