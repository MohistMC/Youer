...
description: Generate or reset deterministic random values.
edition: java
...
execution: player
risk: READ_ONLY
source: https://minecraft.wiki/w/Commands/random
---

# Purpose
Generate or reset deterministic random values. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
