...
description: Display particles at a position for selected viewers.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/particle
---

# Purpose
Display particles at a position for selected viewers. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
