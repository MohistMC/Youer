...
description: End a function and return a value to its caller.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/return
---

# Purpose
End a function and return a value to its caller. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
