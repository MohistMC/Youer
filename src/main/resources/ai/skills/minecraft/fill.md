...
id: minecraft.fill
title: Fill Command
description: Replace blocks throughout a cuboid region.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/fill
---

# Purpose
Replace blocks throughout a cuboid region. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
