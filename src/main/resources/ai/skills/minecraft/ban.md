...
id: minecraft.ban
title: Ban Command
description: Ban a player profile from the server.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/ban
---

# Purpose
Ban a player profile from the server. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
