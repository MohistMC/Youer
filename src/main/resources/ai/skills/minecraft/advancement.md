...
title: Advancement Command
description: Manage player advancement progress.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/advancement
---

# Purpose
Manage player advancement progress. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
