...
description: Stop sounds for selected players.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/stopsound
---

# Purpose
Stop sounds for selected players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
