---
id: minecraft.defaultgamemode
title: Defaultgamemode Command
description: Set the default game mode for joining players.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/defaultgamemode
---

# Purpose
Set the default game mode for joining players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
