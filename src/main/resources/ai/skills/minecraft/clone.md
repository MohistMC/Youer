...
id: minecraft.clone
title: Clone Command
description: Copy blocks from one cuboid region to another.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/clone
---

# Purpose
Copy blocks from one cuboid region to another. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
...
# Examples
`/clone 0 64 0 10 70 10 20 64 20 replace`
