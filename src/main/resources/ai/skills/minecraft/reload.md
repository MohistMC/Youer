...
description: Reload data packs and server data.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/reload
---

# Purpose
Reload data packs and server data. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
