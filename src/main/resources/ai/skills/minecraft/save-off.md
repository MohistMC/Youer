---
id: minecraft.save-off
title: Save Off Command
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/save-off
---

# Purpose
Disable automatic world saving. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
