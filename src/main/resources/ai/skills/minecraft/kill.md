...
id: minecraft.kill
title: Kill Command
description: Remove selected entities by dealing fatal damage.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/kill
---

# Purpose
Remove selected entities by dealing fatal damage. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
