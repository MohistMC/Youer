...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/bossbar
---

# Purpose
Create and manage custom boss bars. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
...
# Examples
`/bossbar add youer:event {"text":"Event"}`
