...
title: Forceload Command
description: Manage chunks that remain loaded without nearby players.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/forceload
---

# Purpose
Manage chunks that remain loaded without nearby players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
