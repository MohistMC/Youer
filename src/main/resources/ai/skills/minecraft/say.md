...
execution: console
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/say
---

# Purpose
Broadcast a server message to all players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
