---
id: minecraft.pardon-ip
title: Pardon Ip Command
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/pardon-ip
---

# Purpose
Remove an IP address from the ban list. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
