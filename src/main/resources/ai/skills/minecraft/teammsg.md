---
id: minecraft.teammsg
title: Teammsg Command
description: Send a message to the sender's scoreboard team.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/teammsg
---

# Purpose
Send a message to the sender's scoreboard team. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
