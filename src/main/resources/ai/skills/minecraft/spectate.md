...
title: Spectate Command
description: Make one player spectate an entity or stop spectating.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/spectate
---

# Purpose
Make one player spectate an entity or stop spectating. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
...
# Examples
`/spectate @e[type=minecraft:zombie,limit=1] @s`
