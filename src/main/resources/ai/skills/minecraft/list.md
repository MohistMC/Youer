...
id: minecraft.list
title: List Command
description: List online players and optional UUID details.
edition: java
...
execution: console
risk: READ_ONLY
source: https://minecraft.wiki/w/Commands/list
---

# Purpose
List online players and optional UUID details. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
