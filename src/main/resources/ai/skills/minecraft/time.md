...
id: minecraft.time
title: Time Command
description: Inspect or change world time.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/time
---

# Purpose
Inspect or change world time. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
