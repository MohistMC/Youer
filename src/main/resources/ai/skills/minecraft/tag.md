...
id: minecraft.tag
title: Tag Command
description: Add, remove, or list scoreboard tags on entities.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/tag
---

# Purpose
Add, remove, or list scoreboard tags on entities. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
