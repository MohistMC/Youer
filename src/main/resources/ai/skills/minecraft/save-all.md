---
id: minecraft.save-all
title: Save All Command
description: Save player and world data to disk.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/save-all
---

# Purpose
Save player and world data to disk. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
