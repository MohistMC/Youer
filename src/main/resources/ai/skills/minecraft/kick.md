...
execution: console
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/kick
---

# Purpose
Disconnect a player with an optional reason. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
