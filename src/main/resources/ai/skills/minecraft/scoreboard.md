...
description: Manage objectives, scores, and display slots.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/scoreboard
---

# Purpose
Manage objectives, scores, and display slots. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
