...
id: minecraft.seed
title: Seed Command
description: Read the current world's seed.
edition: java
...
execution: console
risk: READ_ONLY
source: https://minecraft.wiki/w/Commands/seed
---

# Purpose
Read the current world's seed. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
