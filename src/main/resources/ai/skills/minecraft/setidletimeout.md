---
id: minecraft.setidletimeout
title: Setidletimeout Command
description: Set the automatic idle-player kick timeout.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/setidletimeout
---

# Purpose
Set the automatic idle-player kick timeout. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
