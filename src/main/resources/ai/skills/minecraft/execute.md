...
description: Run another command under controlled conditions and contexts.
edition: java
...
# Purpose
Run another command under controlled conditions and contexts. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
...
# Examples
`/execute as @a at @s run say ready`
