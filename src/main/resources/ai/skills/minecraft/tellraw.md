...
description: Send a JSON text component to selected players.
edition: java
...
execution: console
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/tellraw
---

# Purpose
Send a JSON text component to selected players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
