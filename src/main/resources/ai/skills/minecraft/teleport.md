...
description: Teleport entities to positions or other entities.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/teleport
---

# Purpose
Teleport entities to positions or other entities. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
