...
id: minecraft.tick
title: Tick Command
description: Inspect or control server tick execution.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/tick
---

# Purpose
Inspect or control server tick execution. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
