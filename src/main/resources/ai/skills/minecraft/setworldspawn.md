...
description: Set the world's global spawn position.
edition: java
...
execution: player
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/setworldspawn
---

# Purpose
Set the world's global spawn position. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
