...
description: Inspect or change enabled data packs.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/datapack
---

# Purpose
Inspect or change enabled data packs. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
