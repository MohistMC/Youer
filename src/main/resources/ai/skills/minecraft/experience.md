...
description: Add, set, or query player experience.
edition: java
minecraft_version: 1.21.1
commands: [experience,xp]
tools: [search_commands, execute_player_command]
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/experience
---

# Purpose
Add, set, or query player experience. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
