...
id: minecraft.place
title: Place Command
description: Place a configured feature, jigsaw, structure, or template.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/place
---

# Purpose
Place a configured feature, jigsaw, structure, or template. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
