...
id: minecraft.data
title: Data Command
description: Read or modify NBT data on entities, blocks, or storage.
edition: java
...
# Purpose
Read or modify NBT data on entities, blocks, or storage. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
