...
description: Create an entity at a position with optional NBT.
edition: java
...
execution: player
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/summon
---

# Purpose
Create an entity at a position with optional NBT. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
