...
title: Attribute Command
description: Inspect or modify an entity attribute and its modifiers.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/attribute
---

# Purpose
Inspect or modify an entity attribute and its modifiers. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
