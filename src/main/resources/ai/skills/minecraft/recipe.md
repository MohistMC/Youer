...
description: Grant or revoke crafting recipes for players.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/recipe
---

# Purpose
Grant or revoke crafting recipes for players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
