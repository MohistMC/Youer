---
id: minecraft.banlist
title: Banlist Command
description: Inspect active player and IP bans.
edition: java
...
execution: console
risk: READ_ONLY
source: https://minecraft.wiki/w/Commands/banlist
---

# Purpose
Inspect active player and IP bans. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
