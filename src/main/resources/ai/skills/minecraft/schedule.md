---
id: minecraft.schedule
title: Schedule Command
description: Schedule or clear future data-pack function execution.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/schedule
---

# Purpose
Schedule or clear future data-pack function execution. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
