...
description: Inspect or manage the server allowlist.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/whitelist
---

# Purpose
Inspect or manage the server allowlist. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
