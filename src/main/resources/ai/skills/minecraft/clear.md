...
id: minecraft.clear
title: Clear Command
description: Count or remove matching items from player inventories.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/clear
---

# Purpose
Count or remove matching items from player inventories. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
