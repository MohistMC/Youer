...
description: Spread selected entities across an area.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/spreadplayers
---

# Purpose
Spread selected entities across an area. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
