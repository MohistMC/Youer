...
title: Worldborder Command
description: Inspect or configure the world border.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/worldborder
---

# Purpose
Inspect or configure the world border. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
