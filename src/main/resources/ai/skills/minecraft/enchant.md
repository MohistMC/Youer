...
description: Apply an enchantment to a selected player's held item.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/enchant
---

# Purpose
Apply an enchantment to a selected player's held item. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
