...
description: Change the game mode of selected players.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/gamemode
---

# Purpose
Change the game mode of selected players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
