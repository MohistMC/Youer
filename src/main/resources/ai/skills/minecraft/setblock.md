...
description: Place or replace one block at a position.
edition: java
...
execution: player
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/setblock
---

# Purpose
Place or replace one block at a position. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
