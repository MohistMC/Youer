...
id: minecraft.me
title: Me Command
description: Broadcast an emote-style action message.
edition: java
...
# Purpose
Broadcast an emote-style action message. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
