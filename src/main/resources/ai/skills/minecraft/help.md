...
id: minecraft.help
title: Help Command
description: Show command help and syntax information.
edition: java
...
execution: player
risk: READ_ONLY
source: https://minecraft.wiki/w/Commands/help
---

# Purpose
Show command help and syntax information. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
