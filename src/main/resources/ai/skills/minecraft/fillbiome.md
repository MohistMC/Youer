---
id: minecraft.fillbiome
title: Fillbiome Command
description: Change biome data throughout a region.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/fillbiome
---

# Purpose
Change biome data throughout a region. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
...
# Examples
`/fillbiome 0 0 0 31 31 31 minecraft:plains`
