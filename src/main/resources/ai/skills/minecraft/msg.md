...
id: minecraft.msg
title: Msg Command
description: Send a private message to selected players.
edition: java
...
execution: player
risk: PLAYER_ACTION
source: https://minecraft.wiki/w/Commands/msg
---

# Purpose
Send a private message to selected players. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
