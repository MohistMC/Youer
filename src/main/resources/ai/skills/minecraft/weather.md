...
description: Set clear, rain, or thunder weather.
edition: java
...
execution: console
risk: SERVER_ACTION
source: https://minecraft.wiki/w/Commands/weather
---

# Purpose
Set clear, rain, or thunder weather. Use this Skill for Minecraft Java Edition 1.21.1 dedicated-server syntax.
