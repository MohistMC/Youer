...
import ca.spottedleaf.dataconverter.minecraft.versions.V2537;
...
import ca.spottedleaf.dataconverter.minecraft.versions.V2556;
...
import ca.spottedleaf.dataconverter.minecraft.versions.V3202;
...
import ca.spottedleaf.dataconverter.minecraft.versions.V4054;
import ca.spottedleaf.dataconverter.minecraft.versions.V4055;
import ca.spottedleaf.dataconverter.minecraft.versions.V4059;
import ca.spottedleaf.dataconverter.minecraft.versions.V4061;
import ca.spottedleaf.dataconverter.minecraft.versions.V4064;
import ca.spottedleaf.dataconverter.minecraft.versions.V4067;
import ca.spottedleaf.dataconverter.minecraft.versions.V4068;
import ca.spottedleaf.dataconverter.minecraft.versions.V4070;
import ca.spottedleaf.dataconverter.minecraft.versions.V4071;
import ca.spottedleaf.dataconverter.minecraft.versions.V4081;
import ca.spottedleaf.dataconverter.minecraft.versions.V4173;
import ca.spottedleaf.dataconverter.minecraft.versions.V4175;
import ca.spottedleaf.dataconverter.minecraft.versions.V4176;
import ca.spottedleaf.dataconverter.minecraft.versions.V4180;
import ca.spottedleaf.dataconverter.minecraft.versions.V4181;
import ca.spottedleaf.dataconverter.minecraft.versions.V4185;
import ca.spottedleaf.dataconverter.minecraft.versions.V4187;
import ca.spottedleaf.dataconverter.minecraft.versions.V4290;
import ca.spottedleaf.dataconverter.minecraft.versions.V4291;
import ca.spottedleaf.dataconverter.minecraft.versions.V4292;
import ca.spottedleaf.dataconverter.minecraft.versions.V4293;
import ca.spottedleaf.dataconverter.minecraft.versions.V4294;
import ca.spottedleaf.dataconverter.minecraft.versions.V4295;
import ca.spottedleaf.dataconverter.minecraft.versions.V4296;
import ca.spottedleaf.dataconverter.minecraft.versions.V4297;
import ca.spottedleaf.dataconverter.minecraft.versions.V4299;
import ca.spottedleaf.dataconverter.minecraft.versions.V4300;
import ca.spottedleaf.dataconverter.minecraft.versions.V4301;
import ca.spottedleaf.dataconverter.minecraft.versions.V4302;
import ca.spottedleaf.dataconverter.minecraft.versions.V4303;
import ca.spottedleaf.dataconverter.minecraft.versions.V4305;
import ca.spottedleaf.dataconverter.minecraft.versions.V4306;
import ca.spottedleaf.dataconverter.minecraft.versions.V4307;
import ca.spottedleaf.dataconverter.minecraft.versions.V4309;
import ca.spottedleaf.dataconverter.minecraft.versions.V4311;
import ca.spottedleaf.dataconverter.minecraft.versions.V4312;
import ca.spottedleaf.dataconverter.minecraft.versions.V4314;
import ca.spottedleaf.dataconverter.minecraft.versions.V4420;
import ca.spottedleaf.dataconverter.minecraft.versions.V4421;
import ca.spottedleaf.dataconverter.minecraft.versions.V4424;
import ca.spottedleaf.dataconverter.minecraft.versions.V4439;
import ca.spottedleaf.dataconverter.minecraft.versions.V4533;
import ca.spottedleaf.dataconverter.minecraft.versions.V4535;
import ca.spottedleaf.dataconverter.minecraft.versions.V4537;
import ca.spottedleaf.dataconverter.minecraft.versions.V4541;
import ca.spottedleaf.dataconverter.minecraft.versions.V4544;
import ca.spottedleaf.dataconverter.minecraft.versions.V4548;
import ca.spottedleaf.dataconverter.minecraft.versions.V4648;
import ca.spottedleaf.dataconverter.minecraft.versions.V4649;
import ca.spottedleaf.dataconverter.minecraft.versions.V4651;
import ca.spottedleaf.dataconverter.minecraft.versions.V4656;
import ca.spottedleaf.dataconverter.minecraft.versions.V4657;
import ca.spottedleaf.dataconverter.minecraft.versions.V4658;
import ca.spottedleaf.dataconverter.minecraft.versions.V4661;
import ca.spottedleaf.dataconverter.minecraft.versions.V4763;
import ca.spottedleaf.dataconverter.minecraft.versions.V4769;
import ca.spottedleaf.dataconverter.minecraft.versions.V4882;
import ca.spottedleaf.dataconverter.minecraft.versions.V4885;
import ca.spottedleaf.dataconverter.minecraft.versions.V4888;
import ca.spottedleaf.dataconverter.minecraft.versions.V4892;
import ca.spottedleaf.dataconverter.minecraft.versions.V4996;
import ca.spottedleaf.dataconverter.minecraft.versions.V4997;
import ca.spottedleaf.dataconverter.minecraft.versions.V5002;
import ca.spottedleaf.dataconverter.minecraft.versions.V5006;
import ca.spottedleaf.dataconverter.minecraft.versions.V5007;
import ca.spottedleaf.dataconverter.minecraft.versions.V5008;
import ca.spottedleaf.dataconverter.minecraft.versions.V5009;
import ca.spottedleaf.dataconverter.minecraft.versions.V501;
import ca.spottedleaf.dataconverter.minecraft.versions.V5012;
import ca.spottedleaf.dataconverter.minecraft.versions.V5013;
import ca.spottedleaf.dataconverter.minecraft.versions.V5014;
import ca.spottedleaf.dataconverter.minecraft.versions.V5016;
...
public final class MCTypeRegistry {
    ...
    public static final DynamicDataType BLOCK_STATE    = new DynamicDataType("BlockState"); // map, or since 26.3 only the block name for default states
    ...
    private static void registerAll() {
        ...
        V4996.register();
        V4997.register();
        // V5000 adds the simple cushion entity.
        // V5001 only changes DEBUG_PROFILE, which is not handled by DataConverter.
        V5002.register();
        V5006.register();
        V5007.register();
        V5008.register();
