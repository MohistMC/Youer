...
public final class V99 {
    ...
    public static void register() {
        ...
        MCTypeRegistry.ENTITY.addWalker(VERSION, "Minecart", new DataWalker<>() {
            @Override
            public MapType walk(final MapType data, final long fromVersion, final long toVersion) {
        ...
        MCTypeRegistry.ENTITY.addWalker(VERSION, "MinecartSpawner", new DataWalker<>() {
            @Override
            public MapType walk(final MapType data, final long fromVersion, final long toVersion) {
                return MCTypeRegistry.UNTAGGED_SPAWNER.convert(data, fromVersion, toVersion);
            }
        ...
        MCTypeRegistry.ENTITY.addWalker(VERSION, "Villager", new DataWalker<>() {
            @Override
            public MapType walk(final MapType data, final long fromVersion, final long toVersion) {
        ...
        // tile entities
        MCTypeRegistry.TILE_ENTITY.addStructureWalker(VERSION, new DataWalker<>() {
            @Override
            public MapType walk(final MapType data, final long fromVersion, final long toVersion) {
        ...
        MCTypeRegistry.TILE_ENTITY.addWalker(VERSION, "MobSpawner", new DataWalker<>() {
            @Override
            public MapType walk(final MapType data, final long fromVersion, final long toVersion) {
                return MCTypeRegistry.UNTAGGED_SPAWNER.convert(data, fromVersion, toVersion);
            }
        ...
        MCTypeRegistry.LEVEL.addStructureWalker(VERSION, new DataWalker<>() {
            @Override
            public MapType walk(final MapType data, final long fromVersion, final long toVersion) {
        ...
        MCTypeRegistry.ENTITY_CHUNK.addStructureWalker(VERSION, new DataWalker<>() {
            @Override
            public MapType walk(final MapType data, final long fromVersion, final long toVersion) {
        ...
        MCTypeRegistry.SAVED_DATA_SCOREBOARD.addStructureWalker(VERSION, new DataWalker<>() {
            @Override
            public MapType walk(final MapType root, final long fromVersion, final long toVersion) {
        ...
        MCTypeRegistry.SAVED_DATA_STRUCTURE_FEATURE_INDICES.addStructureWalker(VERSION, new DataWalker<>() {
            @Override
            public MapType walk(final MapType root, final long fromVersion, final long toVersion) {
                final MapType data = root.getMap("data");
                if (data == null) {
        ...
        MCTypeRegistry.TEAM.addStructureWalker(VERSION, new DataWalker<>() {
            @Override
            public MapType walk(final MapType root, final long fromVersion, final long toVersion) {
        ...
        MCTypeRegistry.VILLAGER_TRADE.addStructureWalker(VERSION, new DataWalker<>() {
            @Override
            public MapType walk(final MapType root, final long fromVersion, final long toVersion) {
        ...
        MCTypeRegistry.STRUCTURE.addStructureWalker(VERSION, new DataWalker<>() {
            @Override
            public MapType walk(final MapType root, final long fromVersion, final long toVersion) {
