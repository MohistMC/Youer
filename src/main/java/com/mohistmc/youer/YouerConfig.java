...
import com.mohistmc.youer.commands.EnchantLimitCommand;
import com.mohistmc.youer.commands.EntityDamageCommand;
...
public class YouerConfig {
    ...
    public static boolean ai_enable;
    public static String ai_provider;
    public static String ai_baseUrl;
    public static String ai_api_key;
    public static String ai_model;
    public static String ai_system_prompt;
    public static int ai_max_tokens;
    public static int ai_timeout_seconds;
    public static String ai_api_version;
    ...
    private static void youer() {
        ...
        ai_enable = getBoolean("ai.enable", false);
        ai_provider = getString("ai.provider", "deepseek");
        ai_baseUrl = getString("ai.baseUrl", "https://api.deepseek.com/chat/completions");
        ai_api_key = getString("ai.apiKey", "youer");
        ai_model = getString("ai.model", "deepseek-v4-pro");
        ai_system_prompt = getString("ai.system", "你的名字叫小小墨，年龄18岁，是个可爱的女孩子!");
        ai_max_tokens = getInt("ai.max_tokens", 2048);
        ai_timeout_seconds = getInt("ai.timeout_seconds", 60);
        ai_api_version = getString("ai.api_version", "");
