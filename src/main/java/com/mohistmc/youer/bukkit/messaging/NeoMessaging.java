...
public class NeoMessaging {
    ...
    public static PluginChannel setupChannel(Messenger messenger, ResourceLocation location, Set<PluginMessageListenerRegistration> incoming, Set<Plugin> outgoing) {
        return new PluginChannel(messenger, verifyChannel(location, incoming, outgoing), location, incoming, outgoing);
    }
