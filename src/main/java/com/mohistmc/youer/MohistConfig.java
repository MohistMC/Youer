...
public class MohistConfig {
    ...
    public static File mohistyml = new File("mohist-config", "youer.yml");
    ...
    private static void mohist() {
        ...
        mohist_lang = getString("youer.lang", Locale.getDefault().toString());
