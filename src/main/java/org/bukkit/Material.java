...
public enum Material implements Keyed, Translatable, RegistryAware {
    ...
    COPPER_SWORD(21316, 1, 190),
    COPPER_SHOVEL(12063, 1, 190),
    COPPER_PICKAXE(28429, 1, 190),
    COPPER_AXE(21136, 1, 190),
    COPPER_HOE(28483, 1, 190),
    ...
    COPPER_HELMET(30897, 1, 121),
    COPPER_CHESTPLATE(9884, 1, 176),
    COPPER_LEGGINGS(18225, 1, 165),
    COPPER_BOOTS(27031, 1, 143),
