...
public class CraftEventFactory {
    ...
    public static boolean handleBellRingEvent(World world, BlockPos position, EnumDirection direction, Entity entity) {
    ...
    public static EntityPlaceEvent callEntityPlaceEvent(World world, BlockPos clickPosition, EnumDirection clickedFace, EntityHuman human, Entity entity, EnumHand enumhand) {
     ...
     * Bucket methods
     */
    public static PlayerBucketEmptyEvent callPlayerBucketEmptyEvent(WorldServer world, EntityHuman who, BlockPos changed, BlockPos clicked, EnumDirection clickedFace, ItemStack itemInHand, EnumHand enumhand) {
    ...
    public static PlayerBucketFillEvent callPlayerBucketFillEvent(WorldServer world, EntityHuman who, BlockPos changed, BlockPos clicked, EnumDirection clickedFace, ItemStack itemInHand, net.minecraft.world.item.Item bucket, EnumHand enumhand) {
        return (PlayerBucketFillEvent) getPlayerBucketEvent(true, world, who, clicked, changed, clickedFace, itemInHand, bucket, enumhand);
    }

    private static PlayerEvent getPlayerBucketEvent(boolean isFilling, WorldServer world, EntityHuman who, BlockPos changed, BlockPos clicked, EnumDirection clickedFace, ItemStack itemstack, net.minecraft.world.item.Item item, EnumHand enumhand) {
        Player player = (Player) who.getBukkitEntity();
    ...
    public static PlayerInteractEvent callPlayerInteractEvent(EntityHuman who, Action action, BlockPos position, EnumDirection direction, ItemStack itemstack, EnumHand hand) {
        return callPlayerInteractEvent(who, action, position, direction, itemstack, false, hand, null);
    }

    public static PlayerInteractEvent callPlayerInteractEvent(EntityHuman who, Action action, BlockPos position, EnumDirection direction, ItemStack itemstack, boolean cancelledBlock, EnumHand hand, Vec3D targetPos) {
    ...
    public static BlockDispenseLootEvent callBlockDispenseLootEvent(WorldServer worldServer, BlockPos blockPosition, EntityHuman player, List<ItemStack> rewardLoot) {
    ...
    public static VaultDisplayItemEvent callVaultDisplayItemEvent(WorldServer worldServer, BlockPos blockPosition, ItemStack displayitemStack) {
