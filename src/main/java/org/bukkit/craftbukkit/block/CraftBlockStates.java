...
public final class CraftBlockStates {
    ...
    private abstract static class BlockStateFactory<B extends CraftBlockState> {
        ...
        public abstract B createBlockState(World world, BlockPos blockPosition, IBlockData blockData, TileEntity tileEntity);
    }
    ...
    private static class BlockEntityStateFactory<T extends TileEntity, B extends CraftBlockEntityState<T>> extends BlockStateFactory<B> {
        ...
        private final BiFunction<BlockPos, IBlockData, T> tileEntityConstructor;

        protected BlockEntityStateFactory(Class<B> blockStateType, BiFunction<World, T, B> blockStateConstructor, BiFunction<BlockPos, IBlockData, T> tileEntityConstructor) {
        ...
        @Override
        public final B createBlockState(World world, BlockPos blockPosition, IBlockData blockData, TileEntity tileEntity) {
            if (world != null) {
        ...
        private T createTileEntity(BlockPos blockPosition, IBlockData blockData) {
    ...
    private static final BlockStateFactory<?> DEFAULT_FACTORY = new BlockStateFactory<CraftBlockState>(CraftBlockState.class) {
        @Override
        public CraftBlockState createBlockState(World world, BlockPos blockPosition, IBlockData blockData, TileEntity tileEntity) {
    ...
    @Deprecated
    public static BlockState getBlockState(BlockPos blockPosition, Material material, @Nullable NBTTagCompound blockEntityTag) {
        return getBlockState(MinecraftServer.getDefaultRegistryAccess(), blockPosition, material, blockEntityTag);
    }

    public static BlockState getBlockState(IWorldReader world, BlockPos blockPosition, Material material, @Nullable NBTTagCompound blockEntityTag) {
        return getBlockState(world.registryAccess(), blockPosition, material, blockEntityTag);
    }

    public static BlockState getBlockState(IRegistryCustom registry, BlockPos blockPosition, Material material, @Nullable NBTTagCompound blockEntityTag) {
        Preconditions.checkNotNull(material, "material is null");
    ...
    public static BlockState getBlockState(IWorldReader world, BlockPos blockPosition, IBlockData blockData, @Nullable NBTTagCompound blockEntityTag) {
        return getBlockState(world.registryAccess(), blockPosition, blockData, blockEntityTag);
    }

    public static BlockState getBlockState(IRegistryCustom registry, BlockPos blockPosition, IBlockData blockData, @Nullable NBTTagCompound blockEntityTag) {
    ...
    private static CraftBlockState getBlockState(World world, BlockPos blockPosition, IBlockData blockData, TileEntity tileEntity) {
