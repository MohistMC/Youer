...
import org.bukkit.craftbukkit.v1_20_R4.legacy.fieldrename.FieldRenameData;
import org.bukkit.craftbukkit.v1_20_R4.legacy.reroute.DoNotReroute;
import org.bukkit.craftbukkit.v1_20_R4.legacy.reroute.InjectPluginVersion;
import org.bukkit.craftbukkit.v1_20_R4.legacy.reroute.RerouteMethodName;
import org.bukkit.craftbukkit.v1_20_R4.legacy.reroute.RerouteStatic;
...
public class FieldRename {
    ...
    public static LootTables valueOf_Attribute(String name) {
        // We don't have version-specific changes, so just use current, and don't inject a version
        return LootTables.valueOf(FieldRename.convertAttributeName(ApiVersion.CURRENT, name));
    }
}
