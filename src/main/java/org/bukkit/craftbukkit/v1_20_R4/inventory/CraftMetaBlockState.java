...
public class CraftMetaBlockState extends CraftMetaItem implements BlockStateMeta {
    ...
    CraftMetaBlockState(Map<String, Object> map) {
        ...
        this.blockEntityTag = CraftMetaBlockState.getBlockState(this.material, null);
    }
    ...
    void deserializeInternal(CompoundTag tag, Object context) {
        ...
        if (tag.contains(CraftMetaBlockState.BLOCK_ENTITY_TAG.NBT, CraftMagicNumbers.NBT.TAG_COMPOUND)) {
            this.blockEntityTag = CraftMetaBlockState.getBlockState(this.material, tag.getCompound(CraftMetaBlockState.BLOCK_ENTITY_TAG.NBT));
        }
    }
