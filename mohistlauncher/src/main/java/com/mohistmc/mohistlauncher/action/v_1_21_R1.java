...
public class v_1_21_R1 {
    ...
    public static class Install extends Action {
        ...
        protected Install() throws Exception {
            super();
            this.fmlloader = new File(libPath + "net/neoforged/fmlloader/" + mcVer + "-" + forgeVer + "/fmlloader-" + mcVer + "-" + forgeVer + ".jar");
            this.fmlcore = new File(libPath + "net/neoforged/fmlcore/" + mcVer + "-" + forgeVer + "/fmlcore-" + mcVer + "-" + forgeVer + ".jar");
            this.javafmllanguage = new File(libPath + "net/neoforged/javafmllanguage/" + mcVer + "-" + forgeVer + "/javafmllanguage-" + mcVer + "-" + forgeVer + ".jar");
            this.mclanguage = new File(libPath + "net/neoforged/mclanguage/" + mcVer + "-" + forgeVer + "/mclanguage-" + mcVer + "-" + forgeVer + ".jar");
            this.lowcodelanguage = new File(libPath + "net/neoforged/lowcodelanguage/" + mcVer + "-" + forgeVer + "/lowcodelanguage-" + mcVer + "-" + forgeVer + ".jar");
            this.PATCHED = new File(libPath + "net/neoforged/forge/" + mcVer + "-" + forgeVer + "/forge-" + mcVer + "-" + forgeVer + "-server.jar");
        ...
        private void install() throws Exception {
            ...
            copyFileFromJar(universalJar, "data/neoforge-" + mcVer + "-" + forgeVer + "-universal.jar", false);
            if (!needsInstall()) return;
            System.out.println(I18n.as("installation.start"));

            copyFileFromJar(universalJar, "data/neoforge-" + mcVer + "-" + forgeVer + "-universal.jar", true);
